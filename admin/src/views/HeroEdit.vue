      ...
      <el-tabs value="basic" type="border-card">
        <el-tab-pane label="基础信息" name="basic">
          ...
          <el-form-item label="难度">
            <el-rate style="margin-top:0.6rem;" :max="9" show-score v-model="model.scores.difficult">skills</el-rate>
          </el-form-item>
        ...
        <el-tab-pane label="技能" name="skills">
          ...
          <el-card v-for="(item, i) in model.skills" :key="i">
        ...
        <el-tab-pane label="最佳搭档" name="partners">
          ...
          <el-card v-for="(item, i) in model.partners" :key="i">
            <el-row type="flex" style="flex-wrap: wrap">
              <el-col>
